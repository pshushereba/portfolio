<template>
  <div>
    <title>Patrick Shushereba - Software Developer, founder, and amateur runner</title>
    <meta
      name="description"
      content="I'm Patrick, a software developer and creator based in Southern California."
    />
    <main>
      <Container class="mt-9">
        <div class="max-w-2xl">
          ...
          <div class="mt-6 flex gap-6">
            ...
            <NuxtLink
              to="https://www.linkedin.com/in/pshushereba/"
              target="_blank"
              class="group -m-1 p-1"
            >
              <svg
